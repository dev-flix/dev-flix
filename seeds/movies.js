...
exports.seed = function(knex, Promise) {
  ...
  return knex('movies').del()
    .then(function () {
     ...
     knex('movies').insert({image:"https://images-na.ssl-images-amazon.com/images/M/MV5BODg0NjQ5ODQ3OF5BMl5BanBnXkFtZTcwNjU4MjkzNA@@._V1_SY1000_CR0,0,666,1000_AL_.jpg", description: "A young boy is arrested by the U.S. Secret Service for writing a computer virus and is banned from using a computer until his 18th birthday. Years later, he and his new-found friends discover a plot to unleash a dangerous computer virus, but they must use their computer skills to find the evidence while being pursued by the Secret Service and the evil computer genius behind the virus.", title: 'Hackers', genre: 'Comedy, Crime, Drama', classification: 'PG-13', rating: 62 , minAge: 13}),

     knex('movies').insert({image:"https://images-na.ssl-images-amazon.com/images/M/MV5BOTZiZmZiODktNjFlZC00YTczLWEzOWItMGY4MTY5YjJkZTY0XkEyXkFqcGdeQXVyNDk3NzU2MTQ@._V1_SY1000_CR0,0,666,1000_AL_.jpg", description: "A computer programmer's dream job at a hot Portland-based firm turns nightmarish when he discovers his boss has a secret and ruthless means of dispatching anti-trust problems.", title: 'Antitrust', genre: 'Action, Crime, Drama', classification: 'PG-13', rating: 61 , minAge: 13}),

     knex('movies').insert({image:"https://images-na.ssl-images-amazon.com/images/M/MV5BMDMyMmQ5YzgtYWMxOC00OTU0LWIwZjEtZWUwYTY5MjVkZjhhXkEyXkFqcGdeQXVyNDYyMDk5MTU@._V1_SY1000_CR0,0,723,1000_AL_.jpg", description: "A computer hacker learns from mysterious rebels about the true nature of his reality and his role in the war against its controllers.", title: 'The Matrix', genre: 'Action, Sci-Fi', classification: 'R', rating: 87 , minAge: 16}),

     knex('movies').insert({image:"https://images-na.ssl-images-amazon.com/images/M/MV5BMTU2NjA0NDk0NV5BMl5BanBnXkFtZTcwOTA0OTQzMw@@._V1_SY1000_CR0,0,621,1000_AL_.jpg", description: "A man decides to turn his moribund life around by winning back his ex-girlfriend, reconciling his relationship with his mother, and dealing with an entire community that has returned from the dead to eat the living.", title: 'Shaun of the Dead', genre: 'Comedy, Horror', classification: 'R', rating: 80 , minAge: 16}),

     knex('movies').insert({image:"https://images-na.ssl-images-amazon.com/images/M/MV5BMTk3NjEwNDMzMF5BMl5BanBnXkFtZTgwMzgwNDgwNzE@._V1_.jpg", description: "Four weeks after a mysterious, incurable virus spreads throughout the UK, a handful of survivors try to find sanctuary.", title: '28 Days Later...', genre: ' Drama, Horror, Sci-Fi', classification: 'R', rating: 76 , minAge: 16}),
